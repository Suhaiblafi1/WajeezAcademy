...
- **قاعدة «المجهول = 2.5»:** في V1 كانت كل مهارة غير مقيسة تُحسب فجوة بمستوى 2.5 افتراضيًا (1226 فجوة افتراضية في هذه العينة)؛ في V2 المهارة غير المقيسة «مجهولة» صراحة: لا فجوة ولا تفسير، وتظهر في خانة «ما لم نعرفه».
