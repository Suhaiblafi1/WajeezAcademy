...
/* كان هنا `root` محسوبا من import.meta.url بصعود مستويين — صحيح للمصدر
   ...
   الاستيراد الثابت يزيل الحساب والقراءة معا: المجمِّع يضمّن الملفّ لأنّه
   يتبع الاستيرادات لا مسارات readFileSync المحسوبة — فالملف موجود قطعا حيث
   يُقرأ. وحزمةُ Vercel زالت بزوالها، والقاعدةُ تبقى على أيّ مضيف. */
