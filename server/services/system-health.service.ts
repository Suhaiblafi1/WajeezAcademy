  ...
  private async storage(now: Date): Promise<HealthItem[]> {
    ...
    return [
      ...
      },
      {
        ...
        meaningAr:
          'سجلُّ الأثر يُحفظ سنتَين (هو جوابُ «من غيّر هذا؟»)، **إلّا أثرَ العقود والعروض فيُحفظ أبدا** — دليلٌ في نزاعٍ قد يقع بعدهما. والإشعارُ المقروءُ تسعين يوما، وأحداثُ الاستخدام وخطّافُ الدفع سنةً، ومحاولاتُ الدخول تسعين يوما. '
