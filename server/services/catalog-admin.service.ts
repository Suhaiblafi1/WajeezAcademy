...
export class CatalogAdminService {
  ...
  async createCourse(input: {
    ...
    modules: { sequence: number; titleAr: string; outcomeAr?: string; activityAr?: string; artifactAr?: string; bodyAr?: string; checksAr?: string; hours: number }[]
  }, actorId?: string) {
