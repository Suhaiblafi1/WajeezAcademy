/* خدمة الإشعارات — داخل المنصة فعالة الآن؛ WhatsApp وSMS تنتظران مزودا.
   كل نجاح وفشل ومحاولة موثقة في سجل الإشعار نفسه.

   ─────────── ولا تقل «لا إرسالَ في التطوير» ───────────

   كان هنا: «لا إرسال حقيقي في التطوير أبدا». **ولا شيءَ يفي بذلك**: ليس في
   المنصّة وسمُ تطويرٍ ولا مفتاحُ تعطيل. والذي يمنع الإرسالَ محلّيّا هو غيابُ
   مفتاح Resend وحدَه — فمن صدّر `RESEND_API_KEY` في جهازه ليجرّب شيئا، خرج
   البريدُ إلى عناوين البذرة حقيقةً.

   ووعدُ أمانٍ لا آلةَ خلفه أسوأُ من لا وعد: من قرأه اطمأنّ ولم يحترس. */
