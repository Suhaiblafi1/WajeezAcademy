 ...
 * عن Vercel (ثمّ صارت على Hetzner)، فبقيت القراءةُ على أسمائها وبقي
 * المتغيّرُ غيرَ موجود — فردّ
 ...
 * نسخةَ Git حاضرةٌ على القرص وقتَ البناء (وهي حاضرةٌ على Hetzner، فالنشرُ
 * سحبٌ من GitHub ثمّ بناءٌ على الخادم — `deploy/deploy.sh`). فيُكتب الختمُ ملفّا وقتَ البناء (`scripts/write-build-stamp.ts`)
