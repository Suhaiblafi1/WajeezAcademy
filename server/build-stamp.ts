 ...
 *
 * كان هذا السؤال يُجاب من متغيّراتٍ اسمُها `VERCEL_*`. ثمّ انتقلت المنصّةُ عن
 * Vercel إلى خادمٍ نملكه، فبقيت القراءةُ على أسمائها وبقي المتغيّرُ غيرَ موجود — فردّ
 ...
 * نسخةَ Git حاضرةٌ على القرص وقتَ البناء (وهي حاضرةٌ عندنا، فالنشرُ سحبٌ من
 * GitHub ثمّ بناءُ صورةٍ من الشجرة نفسِها). فيُكتب الختمُ ملفّا وقتَ البناء
 * (`scripts/write-build-stamp.ts`)
...
/* المواضعُ المحتملة — ومقصودٌ ألّا يكون فيها اشتقاقٌ من موضع هذه الوحدة.
   ...
   والسببُ تاريخيٌّ وما زال نافعا: كان الإنتاج يشغّل حزمةً مجمَّعةً في ملفٍّ
   واحد، فالصعودُ من موقع الوحدة يحسب صحيحا في المصدر وخاطئا في الحزمة — عطبٌ
   أسقط تحليلَ الأثر على الإنتاج مرّةً. وقد زالت الحزمةُ (يُشغَّل `server/index.ts`
   مباشرةً)، لكنّ القاعدةَ تبقى: موضعُ الوحدة ليس مرجعا لمسارٍ تُقرأ منه بيانات،
   لأنّه يتغيّر بتغيّر طريقة التشغيل بلا أن يتغيّر السطر.
