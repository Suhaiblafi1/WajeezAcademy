...
/* مُشغِّلُ العامل الخلفيّ — عمليّةٌ واحدةٌ إلى جانب الخادم.
   ...
   في الطابور. **وذلك المانعُ زال**: المنصّةُ على Cloudways، والخادمُ عمليّةُ
   Node دائمةٌ تحت Supervisor، وهذا الملفُّ عمليّةٌ ثانيةٌ إلى جانبها — لا
   خدمةٌ خارجيّةٌ ولا مكتبةُ طوابير.
