...
/* مُشغِّلُ العامل الخلفيّ — يُكتب اليومَ ويُشغَّل يومَ يوجد خادمٌ دائم.
   ...
   لماذا لم يكن يعمل: كانت المنصّةُ على Vercel، ودالّتُها تستيقظ للطلب وتنام
   بعده — فلا موضعَ لحلقةٍ تعمل كلَّ دقيقة. ولذلك بقيت الوعودُ في الطابور.
   والحلُّ خادمٌ دائم (المرحلة ٤ في الخطّة) — **وقد صار موجودا**: خادمُ
   Hetzner. وخدمتُه في `deploy/compose.prod.yml` وراء `profiles: ["worker"]`
   فلا تبدأ وحدَها: أوّلُ تشغيلٍ يصرّف طابورا متراكما، وشرطُه المسجَّل وصلُ
   البريد. وهذا الملفُّ ما يُشغَّل عليه:
