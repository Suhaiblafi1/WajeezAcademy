...
/* ═══ أربعُ محطّات، وثلاثٌ منها نموذج ═══

   قرارُ صاحب المنصّة (١٨ سبتمبر ٢٠٢٦): «بالنسبة لنا هذا إتمامُ طلب، ولكن له
   تتبيّن وكأنّه انتقل للمرحلة الأخيرة وهي حجزُ الموعد».

   وكانت ثلاثا تنتهي بـ«الإرسال»: يضغط المتقدّمُ فيرى شاشةَ نجاحٍ ظنُّه أنّه
   فرغ — وتحتها تقويمٌ لم يَعِده به شيء، فيغلقها ولا يحجز. ثمّ نحسبه متأخّرا
   وهو ينتظرنا.

   فالرابعةُ ليست خطوةً في النموذج: `step` يبقى ١..٣ ومعه حرّاسُه (زرُّ
   «التالي» لا يُرسل، والإرسالُ من خطوته وحدَها). وهي **محطّةٌ تُرى** —
   «todo» ما دام النموذجُ مفتوحا، و«current» في شاشة «وصل طلبك». */
export const STEPS = [
  { n: 1, title: "معلوماتك وخبرتك", hint: "من أنت وماذا تُتقن" },
  { n: 2, title: "نماذجك وأدلتك", hint: "سيرتك ودوراتك وتوفّرك" },
  { n: 3, title: "كيف نصل إليك", hint: "بريدك ووسيلتك المفضّلة" },
  { n: 4, title: "حجز لقاء التعارف", hint: "آخرُ خطوة — تختار وقتَك بنفسك" },
] as const;

/** محطّاتُ النموذج وحدَها — وما بعدها يُحجَز لا يُملأ */
