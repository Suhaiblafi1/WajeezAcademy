...
export default function CohortOps({ cohortId }: { cohortId: string }) {
  ...
  return (
    <div className="space-y-5">
      ...
      {/* ── و«موادُّ الشعبة» حُذفت (١٥ سبتمبر ٢٠٢٦) ──
         انتقلت أوّلا إلى «المصادر» (ع-١) في `CohortMaterials.tsx`، ثمّ قال
         صاحبُ المنصّة: «لا داعيَ لخانة مواد الشعبة كلّيّا». وما كانت تحمله
         له بابُه: ملفٌّ للمتعلّم يُرفع في «كتبٌ وملفّات» فيمرّ بالاعتماد،
