        ...
        <div className="reveal is-visible mt-11 flex flex-col items-center justify-center">
          ...
          {/* ── السطرُ تحت الدعوة: ما يقع بعد النقر ──
              ...
              **والنصُّ يُقاس بوجهة الزرّ لا بما نتمنّاه:** هذه مرساةٌ إلى
              ...
              والمؤشّرُ **سؤالان** (`mirrorQuestions`) وإجاباتُهما تُحفظ على
              جهاز الزائر وحدَه. فوعدُ «ثلاث دقائق» أو «مسارٌ مفسّر» هنا وعدٌ
              لا يفي به هذا الزرّ — وهي عينُها العلّةُ التي عولجت في دعوة
              الختام حين كانت تعِد بخريطةٍ ثمّ تهبط بالزائر إلى المؤشّر. */}
          <p className="mt-2.5 text-read leading-5 text-muted-foreground">
            سؤالان سريعان · بلا حساب · إجاباتك على جهازك
          </p>
