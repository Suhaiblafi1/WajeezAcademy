...
/* ───────────────── page ─────────────────
   ...
   ← أرقام وجيز مهارات الموثقة ← مخرجات التعلم ← مسارات ودورات مميزة ← قصص حقيقية
  ...
  return (
    <div ref={topRef} dir="rtl" className="min-h-screen bg-background text-foreground">
      ...
      <div>
        ...
        <HowItWorks />
        <Partners />
        {/* «وجيز مهارات بالأرقام» — **أسفلَ شركائنا** بقرار صاحب المنصّة
            (٧ سبتمبر ٢٠٢٦). والأرقامُ موثقةٌ من `data/trustMetrics`:
            نطاقُ `wajeez_skills` وحدَه، ولا رقمَ بلا مصدرٍ وتاريخِ تحقّق. */}
        <TrustMetricsBar />
        <ProofBand />
        <Bestsellers />
        <Stories />
