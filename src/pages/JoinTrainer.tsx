    ...
    <SiteShell>
      ...
      <div className="mx-auto max-w-3xl">
        ...
        <p className="mt-4 max-w-2xl text-base leading-8 text-foreground">
          مدربو وجيز لا يلقون دروسا مسجلة فحسب — يراجعون واجبات، ويرافقون متعلّمين، ويقيّمون مشاريع ختام المسار.
              ...
              <Question n={2} title="عملك اليوم" hint="ما تعمله الآن يقول لنا أيّ الدورات أقرب إليك.">
                <FieldRow>
                  ...
                  <Field
                    ...
                    htmlFor="jt-bio"
                    wide
                    hint="هذه النبذةُ تظهر في صفحتك العامّة بعد اعتمادك — يقرؤها من ينقر اسمَك في «المدربون» أو في مسارٍ تدرّبه. فاكتبها لمتدرّبٍ يوازن بينك وبين غيرك، لا لموظّفٍ يراجع طلبك."
                  >
                    {/* ثلاثةُ أسطرٍ كان الحقلُ يعرضها والمثالُ فيه أربعة — فمن
                        ...
                        ═══ والمثالُ صار نبذةً تصلح للعرض العامّ ═══

                        قرارُ صاحب المنصّة (١٣ سبتمبر ٢٠٢٦). وكان المثالُ سيرةً
                        ذاتيّةً تُقرأ لموظّفٍ يراجع: «أعمل مديرا لتحليل البيانات
                        في شركة اتّصالات». وهذه النبذةُ نفسُها تظهر في
                        `TrainerPublic` بعد الاعتماد — يقرؤها متدرّبٌ يوازن بين
                        مدرّبَين، لا مراجعٌ يفحص طلبا.

                        فصار المثالُ يبدأ بما يُدرّبه، ثمّ ما يُصدّقه، ثمّ ما
                        يخرج به المتدرّب. **والتلميحُ يقول صراحةً إنّها تُنشَر**:
                        من كتب نصّا لا يعلم أين يُقرأ كتب غيرَ ما كان سيكتب. */}
                    <textarea
                      ...
                      placeholder="مثال: أُدرّب على تحليل البيانات واتّخاذ القرار بالأرقام. ستّ سنواتٍ في المجال، بنيتُ خلالها وحدةَ التقارير في شركة اتّصالات من الصفر، ودرّبتُ أكثر من ٢٠٠ موظّف على Power BI. أبدأ من بياناتٍ من عمل المتدرّب نفسِه لا من أمثلةٍ جاهزة، ويخرج كلٌّ بلوحة قياسٍ تخصّ شغله."
                    />
