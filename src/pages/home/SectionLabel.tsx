...
/* الأيقونةُ اختياريّةٌ وافتراضُها Sparkles: كانت ثابتةً، فمرّت `icon={Compass}`
   من «أين أنت الآن؟» صامتةً — تُكتب ولا تُقرأ ولا يشتكي أحد. */
export default function SectionLabel({ icon: Icon = Sparkles, children }: { icon?: LucideIcon; children: React.ReactNode }) {
  return (
