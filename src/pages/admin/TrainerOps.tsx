    ...
    <>
      ...
      <FoldSection icon={CalendarCheck} title={`المقابلات (${app.interviews.length})`} id="sec-interviews" omitFromPrint={app.interviews.length === 0}>
        <div className="space-y-3">
          ...
          {/* ═══ ودعوةُ من لم يحجز — نصُّها «مهتمّون بملفّك ونرغب بلقائك» ═══

              كانت تقول «بقيت خطوةٌ واحدة»: نبرةُ استمارةٍ ناقصة. وقرارُ صاحب
              المنصّة (٢٢ سبتمبر ٢٠٢٦) أن تصير دعوةً تقول سببَها — ونصُّها في
              `interview-invitation.ts`، تقرؤه هذه الرسالةُ وبطاقةُ صفحته معا.
          ...
          {canRemindToBook({
            ...
            <div className="border-t border-white/10 pt-3">
              ...
              <p className="mt-1.5 text-read leading-5 text-muted-foreground">
                {/* وما يُقال له مكتوبٌ للموظّف قبل أن يضغط: الرسالةُ تحمل
                    اهتماما بملفّه، فلا تُرسَل على أنّها تذكيرٌ محيَّد. */}
                دعوةٌ تقول «مهتمّون بملفّك ونرغب بلقائك»، وزرُّها إلى صفحة طلبه:
                يسجّل الدخول، يرى حالتَه، ويحجز من تحتها.
              </p>
            </div>
          )}
