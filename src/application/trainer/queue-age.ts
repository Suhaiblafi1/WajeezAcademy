/* عمرُ الطلب في الطابور — «منذ متى وهو واقف، وعند من هو واقف».
   ...
   ═══ ولا شاشةَ تعرضها اليوم (٢٠ سبتمبر ٢٠٢٦) ═══

   كانت شارةً في صفّ الطابور، ثمّ حُذفت منه بقرار صاحب المنصّة: «شارة العمر
   احذفها نهائيّا من الصفّ» — فلم يبقَ للصفّ إلّا الاسمُ والرقمُ والحالةُ
   ونتيجةُ اللقاء. والقاعدةُ تُركت هنا كاملةً محروسةً: قولُها في متى يُستعجَل
   الطلبُ صحيحٌ وإن لم يُعرض، ومن أرادها في ملخّصٍ أو شاشةٍ أخرى وجدها كما
   هي. و`DAY_FORMS` منها يُقرأ في ملخّص من لم يحجز (`unbooked-digest.ts`).

   فلا يُقرأ هذا الرأسُ وعدا بشارةٍ في الشاشة: هو قاعدةٌ تنتظر مُناديا. */
