...
const HIGH: readonly string[] = [
  ...
  /* ═══ والإلغاءُ وقبولُ التعديل معهما (٢٦ سبتمبر ٢٠٢٦) ═══

     كلاهما يُغلق عقدا **خرج إلى صاحبه** ويميت رابطَه، وكلاهما يصله بريدا
     في معالجه يقول ما جرى ولماذا: الإلغاءُ سببَه، وقبولُ التعديل أنّ عقدا
     مصحَّحا يُعَدّ له. ومن أُغلق عقدُه ولم يُخبَر يفتح رابطا ميّتا ولا يدري. */
  'trainer.contract.revoke', 'trainer.contract.amendment_reissue',
  /* ═══ واسمُ الطرف الثاني عالٍ بثلاثته (٢٦ سبتمبر ٢٠٢٦) ═══

     الطلبُ فعلُ المدرّب نفسِه فيصله إشعارُ وصوله، والإعادةُ تُغلق عقدا خرج
     إليه وترسل إليه بديلَه، وتثبيتُ الاسم **يغيّر كيف تسمّيه وثائقُنا** —
     وهو من «تغيّر سجلُّه» بنصّ رأس هذا الملفّ، ومن أُعيدت تسميتُه بلا علمه
     يجب أن يعرف. */
  'trainer.contract.name_correction_requested', 'trainer.contract.name_reissue',
  'trainer.legal_name.set',
...
const LOW: readonly string[] = [
  ...
  /* ═══ ونُقل الإلغاءُ من هنا إلى `high` (٢٦ سبتمبر ٢٠٢٦) ═══

     كان معه لأنّه — كالتركيب — لا يُخبِر أحدا: يحدّث الصفَّ ويميت الرمزَ
     ويسكت. وقد صار يُرسل إلى صاحبه سببَ الإلغاء بحرفه، فتبدّلت الصفةُ التي
     وُزن بها. والتركيبُ يبقى: مسودّةٌ لم يرَها أحدٌ بعد. */
  'trainer.contract.compose',
