...
const PHRASES: Record<string, string> = {
  ...
  /* ورفعُ إيقافٍ بلا فاعلٍ كذلك: حسابُ مؤسِّسٍ موقوفٌ يعود نشطا عند الإقلاع.
     وهو الفعلُ الوحيدُ الذي يُعيد دخولا سُلب بلا قرارِ إنسانٍ يُراجَع — فاسمُه
     يقول «تلقائيّا» كأخيه، ولا يُقرأ سطرٌ في السجلّ على أنّه قرارُ أحد. */
  'auth.founder.reinstated': 'رفعُ الإيقاف عن حسابِ مؤسِّسٍ تلقائيّا',
  ...
  /* ٢١ سبتمبر ٢٠٢٦: قرارُ رابط التقييم يُعكَس على الموعد، والعمودُ لا يسع
     قولَين — فإن اختلف قارئان سُحب المكتوبُ وبقي القولان في الصفّ بأسمائهما. */
  'trainer.interview.outcome_cleared': 'سحبُ نتيجةِ مقابلةٍ لاختلافِ قرّائها',
  ...
  /* بابُ الموسم — ثلاثةُ أفعالٍ تُقرأ كثيرا يومَ يُفتح، فعباراتُها كاملة */
  'registration.season.close': 'إيقافُ التسجيل حتّى يُفتح بابُ الموسم',
  'registration.season.open': 'فتحُ باب التسجيل للموسم',
  'registration.season.notify': 'إبلاغُ من ترك بريدَه أنّ البابَ فُتح',
  /* فعلٌ واحدٌ لفاعلَين: تنقله الإدارةُ بيدها، وينقله التقويمُ حين تمضي
     الأشهرُ (حمولتُه `byCalendar`) — والفاعلُ في الأثر يفرّق بينهما. */
  'term.status': 'نقلُ حالةِ فصلٍ دراسيّ',
  ...
  /* بابُه أُغلق (١٧ سبتمبر ٢٠٢٦) ولم يعد يُكتب — والمعجمُ يبقى
     ليُقرأ ما كُتب قبله؛ سجلُّ أثرٍ بلا معجمٍ سطرٌ برمزٍ لا يفهمه أحد. */
  ...
  /* ك-٥: إذنُ ترشيحِ دورةٍ وحدَها في التشخيص — ومعه مجالُها وجمهورُها */
  'catalog.course.standalone_set': 'إذنُ ترشيحِ دورةٍ وحدَها ومجالُها وجمهورُها',
  /* ح-٤: وخلقُ المهارة نفسِها — والتركيبُ يُخرجها «إنشاء · مهارة · كتالوج»،
  ...
  'trainer.contract.condition_extended': 'تمديدُ مهلةِ المدرّبِ يومين',
  ...
  /* ═══ واسمُ الطرف الثاني — ثلاثةُ أفعالٍ لا واحد ═══
     ...
     الطلبُ فعلُ المدرّب، والإعادةُ فعلُ الموظّف، وتثبيتُ الاسم في الملفّ
  ...
  /* ═══ خصمُ المدرّب — البندان 4-9 و4-10 (٢١ سبتمبر ٢٠٢٦) ═══

     وبعباراتٍ كاملةٍ لا بالتركيب: `trainer_discount` ليس في معجم المقاطع،
     ولو أُضيف لصار «خصمُ مدرّب · إصدار» — وهي لا تقول أنّ **المدرّبَ هو
     المُصدِر ومن جيبه**، وذاك كلُّ معنى هذه الأفعال. */
  'trainer_discount.issue': 'إصدارُ مدرّبٍ خصما من حسابه',
  'trainer_discount.revoke': 'إلغاءُ مدرّبٍ خصما أصدره قبل استعماله',
  'trainer_discount.used': 'استعمالُ خصمِ مدرّبٍ في شراءٍ مدفوع',
  'trainer_discount.used_failed': 'تعذّرُ قيدِ استعمالِ خصمِ مدرّب',
