...
const PHRASES: Record<string, string> = {
  ...
  /* ع-٢: المحتوى النظريُّ ملفّا — رفعُه وفكُّه */
  'cohort.module_body.upload': 'إرفاقُ ملفِّ المحتوى النظريّ لمحور',
  'cohort.module_body.remove': 'حذفُ ملفِّ المحتوى النظريّ لمحور',
