  ...
  },
  {
    ...
    templateKeys: [
      ...
      /* ═══ وعروضُ الإسناد — وهي عملٌ من الطرفين ═══
         ...
         فكتمُه يُضيّع عليه عرضا ويترك شعبةً بلا مدرّب. وجوابُه — قبولا أو
         اعتذارا — عملٌ ينتظر من عرَض. وأجلُ الإعداد كذلك: من انقضى أجلُه
         بلا إقرارٍ تُنظَر حالُه بيدِ إنسان، ولا يُسحب إسنادُه بمؤقّت. */
