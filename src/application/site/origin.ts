/* أصل الموقع القانوني — مصدر واحد للنطاق الذي نقول للعالم إنه بيتنا.
   ...
   النطاق الحيّ www.wajeezacademy.com، والموقع عليه اليوم على خادم Cloudways
   ينشر من GitHub تلقائيا. وكان الأصل مكتوبا حرفا في مكانين — SeoHead
   ...
   والترتيب هنا يصحّح نفسه بلا تدخل:
     ١) VITE_SITE_ORIGIN إن ضُبط وقت البناء — الكلمة الأخيرة للمالك، وهو
        الموضع الصحيح لضبطه: متغيّرات البناء على Cloudways.
