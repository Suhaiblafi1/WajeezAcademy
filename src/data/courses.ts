...
/* مختارات وجيز من الدورات — منتقاة تحريريا لكل مجال، بشارات وصفية صادقة */
export const bestsellerCourses: { id: string; note: string }[] = [
  /* أساسيات */
  { id: 'CRS-FND-003-02', note: 'اختيار وجيز' },
  { id: 'CRS-FND-005-03', note: 'مهارة سريعة' },
  /* طلاب ومهنة */
  { id: 'CRS-STU-002-02', note: 'الأنسب للخريجين' },
  { id: 'CRS-CAREER-003-03', note: 'تجربة عملية فورية' },
  /* موظفون */
  { id: 'CRS-EMP-004-01', note: 'الأنسب للموظفين' },
  { id: 'CRS-EMP-002-02', note: 'اختيار وجيز' },
  { id: 'CRS-EMP-003-01', note: 'بداية صحيحة' },
  /* حكومي */
  { id: 'CRS-GOV-001-02', note: 'الأنسب للقطاع الحكومي' },
  { id: 'CRS-GOV-002-03', note: 'أثر مباشر' },
  /* أعمال */
  { id: 'CRS-BIZ-001-02', note: 'لرواد الأعمال' },
  { id: 'CRS-BIZ-004-03', note: 'من مختارات وجيز' },
  ...
  { id: 'CRS-WELL-001-02', note: 'خفيفة ومركّزة' },
]
