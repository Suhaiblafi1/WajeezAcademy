...
/* مجالُ الدورة المعرفيّ — انتقل إلى `application/catalog/course-domain`
   ليقرأه الخادمُ أيضا (مولِّدُ المعرّف يحتاجه)، ويُعاد تصديرُه من هنا كما
   كان: الشاشاتُ تستورده من `@/data/courses` منذ أوّل يوم. */
export {
