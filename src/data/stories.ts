...
/* بيانات التواصل الموثقة — من صفحة اتصل بنا في موقع وجيز الأم.
   واتساب المستشارين يُفعَّل بوضع الرقم الرسمي هنا عند الربط الفعلي؛
   ما دام فارغا تُخفى أزرار واتساب ويظهر البريد بديلا */
export const CONTACT = {
  email: 'support@wajeez.co',
  whatsapp: '', // الرقم الرسمي يُضاف عند الربط — لا يُعرض زر واتساب قبلها
