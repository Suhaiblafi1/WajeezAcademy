...
/* لا يُعرض اسم مدرب إلا بعد اعتماد الشعبة رسميا — عبارة مؤقتة موحدة */
...
export const stories: Story[] = [
  ...
  },
  {
    ...
    turn: 'رشّحته جهته ضمن برنامج التدريب الحكومي مع أكاديمية وجيز، وكشف التشخيص أن فجوته ليست المعرفة بل أدوات التعامل تحت الضغط.',
