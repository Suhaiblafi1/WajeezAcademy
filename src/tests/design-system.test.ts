 ...
 * ── ومتى يُرفَع، وكيف ──
 *
 * رُفع مرّةً واحدةً في ٦ سبتمبر: ٢٩١ ← ٣٤٨ و٣ ← ٢٦. والسبب ثمانيةُ ملفّاتٍ
 * أُرجعت عن الترحيل لتعارضِ أسماء — فيها مكوّنٌ محلّيٌّ اسمُه `Card`، أو
 * استيرادٌ سابقٌ اسمُه `Button` من زرِّ shadcn الموروث. والخلطُ في ملفٍّ واحدٍ
 * لا يُقبَل، فرُدّت إلى ما كانت.
 *
...
/* ═══ السقوف — تُخفَض ولا تُرفع ═══
   ...
   تُخفَض مع كلّ ترحيل: ٧٦٠ ← ٧٥١ (Support) ← ٧٣٨ (Finance) ← ٤٦٦ ← ٣٤٨
   ← ٣٤٦ · وأزرارٌ ٢٣٤ ← ٢٦. وكلُّ ترحيلٍ يُنقص العددَ يُخفض السقفَ في
   الالتزام نفسِه — وإلّا فُتح البابُ لصيغةٍ جديدةٍ مكانَ المُرحَّلة.

   ⚠️ والرقمُ يُقاس ولا يُنقل: كان مكتوبا هنا «٢٩١ سطحا و٣ أزرار» والمقيسُ
   على الشجرة نفسِها ٣٤٨ و٢٦ — أي أنّ سطرَ التاريخ سبق دفعاتٍ تالية. فمن
   يُخفض السقفَ يُشغّل الحارسَ ويأخذ رقمَه، ولا يقرأ هذا السطر. */
const CEILING = {
