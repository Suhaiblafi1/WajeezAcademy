...
const CEILING = {
  ...
  /* ١٤٤ ← ١٤٣ (١٣ سبتمبر ٢٠٢٦): ذهبت كتلةُ الحذف المكتوبةُ بيدها
     (`rounded-2xl border border-red-500/25 …`) وصارت `Panel`. والسقفُ يُخفَض
     مع كلّ ترحيلٍ ولا يُرفع — وإلّا صار فراغا يملؤه انحرافٌ صامت. */
  surface: 143,
