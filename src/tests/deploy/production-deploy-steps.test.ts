...
describe('سكربتُ النشر الحقيقيّ — deploy/deploy.sh', () => {
  ...
  /* ═══ ولماذا يُستأنف السكربتُ نفسَه بعد السحب ═══

     bash يقرأ السكربتَ على دفعاتٍ وهو ينفّذه، لا دفعةً واحدةً قبلَه. و`git
     pull` في الخطوة الأولى يعيد كتابة الملفِّ تحته: فيستأنف القراءةَ من
     إزاحةٍ بالبايت حُسبت على النصّ القديم داخلَ نصٍّ جديد — فتُتخطّى أسطرٌ
     وسطى أو تُقرأ أنصافُها، ويخرج السكربتُ بصفرٍ كأنّ شيئا لم يكن.

     وقد وقع مرّتين (١٢ سبتمبر ٢٠٢٦): أُضيفت إعادةُ تحميل Caddy في وسط
     الملفّ فلم تُنفَّذ، ثمّ أُبدلت بإعادةِ إنشاءٍ فلم تُنفَّذ — والنشرةُ
     تنجح في الحالتين، والترويسةُ وحدَها لا تتغيّر. وأُثبت العطبُ بمحاكاةٍ
     صغيرة: سكربتٌ يُعاد كتابتُه أثناء تنفيذه نفّذ بايتاتٍ مبتورةً
