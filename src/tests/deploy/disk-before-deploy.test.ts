...
/* ═══ مهلةُ المسار الذي يُقلّم — والخمسُ ثوانٍ لا تكفيه ═══

   الحدُّ الافتراضيُّ في vitest خمسُ ثوان، والمسارُ الذي تنقص فيه المساحةُ
   **يُشغّل Docker فعلا** قبل أن يحكم: تقليمُ ذاكرة البناء، ثمّ الصورُ
   المعلَّقة، ثمّ تقليمٌ شاملٌ إن بقي ناقصا. وهي ثلاثةُ أوامرَ تعمل عملا
   حقيقيّا حين يكون للـDaemon مخزنٌ دافئ — أي على عدّاء CI بعينه.

   ووقع (٢٤ سبتمبر ٢٠٢٦): مرّ هذا الحارسُ على جولة #278 نفسِها، ثمّ سقط على
   `main` بالشيفرة عينِها — `Test timed out in 5000ms`. فالفرقُ حالُ المخزن
   لا الشيفرة، وحمرّ `main` فتخطّى سيرُ «نشرِ الإنتاج» نفسَه (يعمل على إتمام
   CI ويُتخطّى حين تسقط). وقيس المحاكاة: `docker` مزيَّفٌ ينام ثلاثا يجعل
   السكربتَ تسعَ ثوانٍ، فيسقط هذا الحارسُ وحدَه بالرسالة نفسِها.

   ═══ ولماذا مهلةٌ لا تعطيلٌ ولا تخطٍّ ═══

   المقيسُ **حكمُ البوّابة** لا سرعةُ التقليم: أتسقط حين لا تتّسع، وأتقول
   الحدَّ وتدلّ على النسخ. وكلُّ دعوى باقيةٌ كما هي، والسكربتُ يُشغَّل حقيقةً
   كما كُتب في رأس الملفّ. وإنّما وُسّع ما لا يُقاس.

   والمقدارُ فسيحٌ عن عمد: تقليمٌ شاملٌ على عدّاءٍ محمَّلٍ يبلغ عشراتِ الثواني،
   وحارسٌ يسقط بالمهلة يُقرأ عطبا في البوّابة — وهو أسوأُ من انتظارٍ نادر. */
...
describe('البوّابةُ تقيس المساحةَ وتحكم', () => {
  ...
  it('وتسقط حين لا تكفي، وتقول كم بقي وكم يلزم', () => {
    ...
    /* وهذا وحدَه يبلغ التقليم: البواقي تخرج قبله — بمساحةٍ تكفي أو بمسارٍ
       لا وجودَ له — فلا مهلةَ لها. */
  }, PRUNE_TIMEOUT_MS)
