/* ما يصل المتقدّمَ عند القرار وعند التذكير — حارسُ نصٍّ يقرؤه إنسانٌ مرّةً.
   ...
   ④ **ودعوةُ الحجز زرُّها إلى صفحة الطلب** — لا إلى التقويم رأسا: قرارُ صاحب
...
/* ═══ دعوةُ من لم يحجز — طريقُها هنا، ونصُّها في حارسٍ آخر ═══
   ...
   ٢٢ سبتمبر ٢٠٢٦). والمفحوصُ هنا طريقُها كما كان: زرٌّ واحدٌ إلى صفحة الطلب،
   ولا رابطَ ثانٍ في المتن، ورقمُ الطلب وحدَه في الحقائق — وهي قراراتُ ١٨ و١٩
   سبتمبر، لا تسقط بتبدّل النبرة.
