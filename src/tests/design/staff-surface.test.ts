...
describe('طوابيرُ الفريق · لا قائمةَ تطول بلا وسيلةِ وصول', () => {
  ...
  const EXEMPT = new Set([
    ...
    'Terms',
    /* تفصيلُ كيانٍ واحد · PreparationSteps — خطواتُ تجهيزِ **مدرّبٍ واحدٍ**
       داخلَ ملفّه (٢٠ سبتمبر ٢٠٢٦): دوراتُه المؤهَّلُ لها، واقتراحاتُه، وعقودُه.
       وهي آحادٌ لا تنمو بنموّ العمل — كـ`Qualifications` سواءً بسواء، وهذه
       أضيقُ منها: نطاقُها إنسانٌ بعينه فُتح ملفُّه.

       والنداءُ الذي أدخلها المسحَ هو `‎/api/admin/catalog/courses` — قائمةُ
       الكتالوج تُملأ بها **خانةُ اختيار**، لا قائمةٌ تُعرض ويُبحث فيها. ومن
       يضيف يوما قائمةً معروضةً في هذه الشاشة فالبحثُ لازمٌ لها، ويُحذف هذا
       الاسمُ من المستثنى. */
    'PreparationSteps',
    /* مجموعةٌ محدودة · ReviewerLinks — قُرّاءُ طلبٍ واحدٍ يُقرأون بأسمائهم،
       وهم آحادٌ لا طابور. ومن كثُروا على طلبٍ واحدٍ فالعطبُ في العدد لا في
       غياب البحث (١٣ سبتمبر ٢٠٢٦). */
    'ReviewerLinks',
    /* مجموعةٌ محدودة · Referral — **روابطُ شعبه المفتوحة**، رابطٌ لكلّ
       واحدةٍ يدرّبها. وهي آحادٌ لا تنمو بنموّ العمل: الشعبُ ما أُسند إليه
       في فصلٍ بعينه، ومن أُسندت إليه عشرون فالعطبُ في العدد لا في غياب
       البحث.

       ⚠️ وكان سببُ الاستثناء قبل ١٥ سبتمبر ٢٠٢٦ **مساراتِه** التي كانت
       تُعرض في هذه الصفحة. وقد خرجت بقرار صاحب المنصّة («لا داعيَ لهذه في
       صفحة دعوتي لأنّها موجودةٌ في خانة مساري») — فلو تُرك السببُ كما كان
       لصار الاستثناءُ قائما على قائمةٍ لا وجودَ لها، ولا يعرف من يقرؤه
       بعد شهرٍ لمَ استُثنيت الصفحة. */
    'Referral',
    /* مجموعةٌ محدودة · MyCourseProposals — دوراتُ **مدرّبٍ واحدٍ يكتبها بيده**:
       ما بذره طلبُه وما أضافه بعده. وهي آحادٌ لا تنمو بنموّ العمل — من كتب
       لنفسه ثلاثين اقتراحا فالعطبُ في العدد لا في غياب البحث.

       وطابورُ الإدارة عليها (`CourseProposals`) يبحث ويرقّم: ذاك يجمع
       اقتراحات المدرّبين كلِّهم، وهو الذي ينمو (١٤ سبتمبر ٢٠٢٦). */
    'MyCourseProposals',
    /* مجموعةٌ محدودة · MyPaths — مساراتُ **مدرّبٍ واحدٍ بناها بيده**، وكلُّ
       مسارٍ ثمانُ دوراتٍ على الأكثر. وهي آحادٌ لا تنمو بنموّ العمل.

       وطابورُ الإدارة عليها (`TrainerPaths`) يبحث ويرقّم: ذاك يجمع مساراتِ
       المدرّبين كلِّهم وهو الذي ينمو (١٤ سبتمبر ٢٠٢٦). */
    'MyPaths',
    /* وخرج `CohortWorkspace` من المستثنى (١٧ سبتمبر ٢٠٢٦): استُثني لقائمة
       الفصول التي كان يختار منها، ثمّ صار الفصلُ يُسمَّى عند الإسناد فزالت
       القائمةُ ونداؤها معا. فلم يبقَ في الشاشة نداءٌ يجلب مصفوفةً أصلا،
       فخرجت من المسح — واسمٌ في المستثنى بلا ملفٍّ يُمسح بابٌ مفتوحٌ لشاشةٍ
       تحمل الاسمَ نفسَه بعدُ فتمرّ بلا بحث، وهو ما يحرسه الفحصُ الأخير. */
  ])
