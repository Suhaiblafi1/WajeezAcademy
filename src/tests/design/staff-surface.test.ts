...
describe('طوابيرُ الفريق · لا قائمةَ تطول بلا وسيلةِ وصول', () => {
  ...
  const EXEMPT = new Set([
    ...
    'Referral',
    /* مجموعةٌ محدودة · CourseTitleProposal — اقتراحاتُ **مدرّبٍ واحدٍ على
       دورةٍ واحدة**، ولا يُرسَل ثانٍ ما دام الأوّلُ حيًّا (`LIVE` في الملفّ).
       فالقائمةُ آحادٌ لا تنمو بنموّ العمل، ومن اقترح لدورةٍ عشرةَ أسماءٍ
       فالعطبُ في العدد لا في غياب البحث (١٤ سبتمبر ٢٠٢٦). */
    'CourseTitleProposal',
    ...
    'MyPaths',
    /* مجموعةٌ محدودة · CohortWorkspace — **الفصولُ الحيّةُ للاختيار**، لا
       طابورَ عملٍ ينمو. والمواسمُ أربعةٌ في السنة (`TRAINING_SEASONS`)،
       والقائمةُ تقتصر على `planned | open | active` — فهي آحادٌ معدودةٌ
       يختار منها المدرّبُ فصلَ شعبته بنقرة، لا صفوفٌ يبحث فيها.

       وسائرُ ما في الشاشة ليس طابورا أصلا: محاورُ الشعبة ومصادرُها
       ولقاءاتُها ومهامُّها — كلُّها ما كتبه هو لهذه الشعبة بعينها
       (١٥ سبتمبر ٢٠٢٦). */
    'CohortWorkspace',
  ])
