...
describe('طوابيرُ الفريق · لا قائمةَ تطول بلا وسيلةِ وصول', () => {
  ...
  const EXEMPT = new Set([
    ...
    'ReviewerLinks',
    /* مجموعةٌ محدودة · Referral — **مساراتُ المدرّب التي بناها هو**، تُعرض
       له في صفحة دعوته ليعرف ما يبلغه رابطُه. وهي آحادٌ لا تنمو بنموّ
       العمل: يبنيها بيده مسارا مسارا، ولموسمٍ بعينه، وبناؤها وإدارتُها في
       «مساراتي» لا هنا — فهذه قراءةٌ لا طابور (١٤ سبتمبر ٢٠٢٦). */
    'Referral',
