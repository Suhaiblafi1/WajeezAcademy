...
/** الدَّينُ المقيس — فعلٌ عالٍ في معالِجٍ لا يُخبِر أحدا
    ...
    كان اثنَين وأربعين يوم كُتب، فصار **تسعةَ عشر**: خمسةٌ سقطت بإصلاح
    الحارس (كان يقرأ أسماءَ المُرسِلين فلا يرى غلافا محلّيّا يُرسل)، وثمانيةَ
    عشرَ بإشعاراتٍ كُتبت فعلا. */
