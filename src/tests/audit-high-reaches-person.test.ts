...
/** الدَّينُ المقيس — فعلٌ عالٍ في معالِجٍ لا يُخبِر أحدا
    ...
    كان اثنَين وأربعين يوم كُتب، فصار **واحدا وعشرين**: خمسةٌ سقطت بإصلاح
    الحارس (كان يقرأ أسماءَ المُرسِلين فلا يرى غلافا محلّيّا يُرسل)، وستّةَ
...
const SILENT_DEBT: readonly string[] = [
  ...
  /* ═══ الشعبةُ ومن أُسند إليها ═══
     ...
     أن يعلم به من يحضرها — عشرون إنسانا في الشعبة الوسطى، ولا رسالةَ
     «صار للقاء رابط» في المنصّة كلِّها. */
