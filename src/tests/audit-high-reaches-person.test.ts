...
/** الدَّينُ المقيس — فعلٌ عالٍ في معالِجٍ لا يُخبِر أحدا
    ...
    كان اثنَين وأربعين يوم كُتب، فصار **تسعةً**: خمسةٌ سقطت بإصلاح الحارس
    (كان يقرأ أسماءَ المُرسِلين فلا يرى غلافا محلّيّا يُرسل)، وثمانيةٌ
    وعشرون بإشعاراتٍ وبرائدَ كُتبت فعلا. */
const SILENT_DEBT: readonly string[] = [
  /* ═══ ما بقي من الحساب: الإقلاعُ وحدَه ═══

     يقع مرّةً عند بدء الخادم ولا فاعلَ له — ويُخبَر به صاحبُه بجرسٍ جمهورُه
     `staff`، فالافتراضُ `learner` يُنزله في بوّابةٍ لا يفتحها. */
