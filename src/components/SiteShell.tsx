      ...
      <header className="sticky top-0 z-40 border-b border-white/10 bg-[#0D0D0D]/85 backdrop-blur">
        <div className="mx-auto flex h-16 max-w-6xl items-center justify-between px-5">
          ...
          <nav className="hidden items-center gap-6 text-sm text-white/55 md:flex">
            <Link to="/pathways" className="transition hover:text-[#6EC7D1]">المسارات</Link>
            <Link to="/courses" className="transition hover:text-[#6EC7D1]">الدورات</Link>
            <Link to="/stories" className="transition hover:text-[#6EC7D1]">القصص</Link>
