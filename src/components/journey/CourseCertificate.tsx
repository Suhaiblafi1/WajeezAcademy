...
export default function CourseCertificate({
  ...
  if (request || sent) {
    ...
    return (
      <Card className="p-3.5">
        <p className="flex flex-wrap items-center gap-2 text-read leading-5 font-black text-foreground">
  ...
  return (
    <Card className="p-3.5">
      <p className="flex items-center gap-1.5 text-read leading-5 font-black text-foreground">
        <Award className="h-4 w-4 text-gold-ink" /> شهادة هذه الدورة
      </p>
      {eligibility === null ? (
        <p className="mt-1.5 flex items-center gap-2 text-read text-muted-foreground">
        ...
        <>
          ...
          <p className="mt-1.5 text-read leading-5 text-muted-foreground">ما يبقى قبل شهادتك:</p>
