      ...
      {done ? (
        ...
        <>
          ...
          <div className="mt-4 overflow-hidden rounded-xl bg-white">
            {/* ═══ أرضيّةٌ واحدةٌ لا أرضيّتان — والعرضُ هو الذي يقرّر ═══

                كانت `min-h-[1040px] sm:min-h-[760px]`: أرضيّةٌ سخيّةٌ على
                الهاتف تنزل الثلثَ على الشاشات الأوسع. والقياسُ خاطئٌ من
                أصله — `sm:` تقيس **الشاشة**، وعرضُ الإطار ليس عرضَ الشاشة:
                هذه البطاقةُ تُركَّب داخلَ عمودٍ سقفُه `max-w-lg` (٥١٢ بكسلا)،
                فالإطارُ يبقى نحوَ ٤٦٠ بكسلا على حاسوبٍ عرضُه ألفان.

                وCalendly يرسم عند ذلك العرض تخطيطَه الضيّق (ترويسةٌ، ثمّ
                «Select a Day»، ثمّ شبكةُ الشهر، ثمّ المنطقةُ الزمنيّة) —
                وهو أطولُ من ٧٦٠ بكسلا لا أقصر. فمن فتح الصفحةَ على حاسوبٍ
                رأى إطارا **مقصوصا عند «Time zone»** يُمرَّر داخلَ نفسه:
                تمريرٌ داخلَ تمرير، وهو بعينه ما شكا منه صاحبُ المنصّة
                (١٥ سبتمبر ٢٠٢٦): «صفحةُ Calendly تتحرّك داخل البوكس —
                اجعلها ثابتةً للسهولة».

                فأرضيّةٌ واحدةٌ سخيّةٌ في كلّ عرض. وثمنُها فراغٌ أبيضُ أسفلَ
                الخطوة الأقصر — وهو أهونُ من محتوًى مقصوصٍ يُبحَث عنه
                بإصبعٍ داخلَ إطار.

                وهي `min-h` لا `h`: فالمقيسُ حين يجاوزها يرفع الصندوقَ، وحين
                يقصر عنها لا يُنقصه — فلا يُقصّ محتوى ولا يرتجّ ما تحته. */}
            <div
              className="relative w-full min-h-[1180px]"
