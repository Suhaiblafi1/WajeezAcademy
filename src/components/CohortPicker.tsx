            ...
            <li key={c.id}>
              ...
              >
                ...
                <span className="min-w-0">
                  <When c={c} />
                  {c.title && <span className="mt-0.5 block truncate text-fine leading-4 text-muted-foreground">{c.title}</span>}
                </span>
                <span className="flex shrink-0 items-center gap-1.5">
                  {typeof c.seatsLeft === "number" && c.seatsLeft <= 5 && (
                    <span className="inline-flex items-center gap-1 rounded-full bg-gold/15 px-1.5 py-0.5 text-fine font-black text-gold-ink">
