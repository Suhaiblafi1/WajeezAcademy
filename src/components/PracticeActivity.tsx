  ...
  return (
    ...
    >
      <div className="flex flex-wrap items-baseline justify-between gap-2">
        ...
        <span className="flex items-center gap-1 rounded-full bg-teal-ink/15 px-2 py-0.5 text-fine tabular-nums text-teal-light-ink">
          ...
          return (
            <li key={i}>
              ...
              >
                ...
                <span className="ms-auto shrink-0 text-fine tabular-nums text-muted-foreground">
                  {fmtNum(s.minutes)} د
                </span>
              </button>
            </li>
      ...
      <dl className="mt-4 space-y-3 text-sm leading-6">
        <Card>
          <dt className="flex items-center gap-1.5 text-fine font-black text-teal-light-ink">
        ...
        <Card>
          <dt className="flex items-center gap-1.5 text-fine font-black text-muted-foreground">
