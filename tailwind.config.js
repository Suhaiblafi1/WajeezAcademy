...
module.exports = {
  ...
  theme: {
    extend: {
      ...
      fontSize: {
        /* ــ ولم يعد يُستعمل: قرارُ ٨ سبتمبر ٢٠٢٦ ــ

           كانت `micro` أرضيّةَ المنصّة، وشاشاتُ الفريق تعمل عليها: **٧٨٪ من
           نصوص لوحة الإدارة بأحدَ عشرَ أو اثنَي عشرَ بكسلا، وصفرُ مواضعَ
           بستّةَ عشر**. وكان ذلك قرارا مكتوبا لا سهوا — «جداولُ الفريق كثيفةٌ
           بقصد».

           ونقضه صاحبُ المنصّة بعد جولةٍ في اللوحة: «غير مريحة… لا أشعر أنّي
           بمنصّةٍ بُنيت عام ٢٠٢٦». والمراجعُ معه: نصُّ الواجهات العربيّة **١٤
           حدًّا أدنى**، والمتنُ المريح ١٨–٢٠ — لأنّ نقاطَها وهمزاتِها فوق
           الحرف وتحته، فتحتاج ١٠–٣٠٪ فوق اللاتينيّة بالحجم نفسِه.

           والكثافةُ مطلبٌ صحيحٌ في شاشات التشغيل، لكنّها تُشترى **بالحشو
           والمسافة والحدّ** لا بتصغير الحرف تحت حدّ القراءة. فصار المتنُ ١٤
           واللصيقةُ ١٢، ولم يبقَ في المستودَع موضعٌ واحدٌ بأحدَ عشر.

           ويبقى الرمزُ معرَّفا ولا يُستعمل: حذفُه يُسكت الحارسَ الذي يمنع
           عودةَ التسعةِ والعشرة، وبقاؤه بلا مستعمِلٍ لا يكلّف شيئا. */
        micro: '11px',
        ...
        fine: '12px',
        /* ــ أرضيّةُ نصّ المتن (البند ② في خطّة التنفيذ) ــ

           `fine` رفعت أرضيّةَ شاشات المتعلّم من أحدَ عشرَ إلى اثنَي عشر.
           والقياسُ بعدها قال إنّ ذلك لم يكفِ: **سبعةٌ وستّون بالمئة من نصوص
           المنصّة بحجم ١١ أو ١٢** — والمتعلّمُ يقرأ نتيجةَ تشخيصِه بالحجم
           الذي تُكتب به حواشي الجداول.

           فصار لنصّ المتن حجمُه: أربعةَ عشرَ. و«المتن» تقوله البنيةُ لا
           العين — الفقرةُ (`<p>`) وعنصرُ القائمة (`<li>`) — وما بقي من
           لصيقاتٍ وشاراتٍ وأزرارٍ يبقى على ١١–١٢ بقصد.

           ── ولماذا رمزٌ ثالثٌ ولا يُكتفى بـ`text-sm` وهي أربعةَ عشرَ أيضا ──

           للسبب نفسِه الذي وُلدت منه `fine`: `sm` تحمل ارتفاعَ سطرٍ معها
           (٢٠px). و`text-fine` **لا تحمله** — فمواضعُها ترث ارتفاعَ الخطّ
           الطبيعيّ (ولا `line-height` على `body` في هذه المنصّة). فتبديلُها
           بـ`sm` يغيّر **شيئين** في مئتَين وتسعةٍ وثمانين موضعا: الحجمَ
           وارتفاعَ السطر — والثاني بلا قرارٍ من أحد.

           فـ`read` تغيّر الحجمَ وحدَه. ومن أراد ارتفاعا سمّاه بجوارها. */
        read: '14px',
      },
      colors: {
