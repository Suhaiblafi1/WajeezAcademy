...
/* الصفحتان العامّتان أوّلا: منهما جاء بلاغ «الخطّ كبير على الهاتف»، ولم تكونا
   في هذا الفحص أصلا. لا تحتاجان الكوكي، والكوكي لا يضرّهما. */
for (const p of ['/', '/diagnostic', '/student', '/student/learning', '/student/cohorts']) {
