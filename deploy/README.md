...
> ⚠️ **تصميمٌ لم يُستعمل قطّ — ليس هذا هو الإنتاج.**
> المنصّةُ على **Cloudways**، لا على خادمٍ بحاويات Docker وCaddy. وما في هذا
> المجلّد تصميمٌ كاملٌ لخادمٍ ذاتيٍّ بُني ولم يُنشر عليه شيء.
> **المرجعُ للواقع الحاليّ: [`docs/DEPLOYMENT.md`](../docs/DEPLOYMENT.md).**
>
> ويبقى المجلّدُ لقيمتين: `backup.sh` (نسخٌ خارجَ الخادم بتحقّقٍ بالاستعادة —
> وهو ما تحتاجه المنصّةُ أيّا كان مضيفُها)، وسياسةُ المحتوى في `Caddyfile`
> التي نُقلت منها إلى `public/.htaccess`.
