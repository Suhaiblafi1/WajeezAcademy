...
**نسخُ Hetzner السحابيّة** — لقطاتُ الخادم كاملا، مُفعَّلةٌ عليه — ومعها
...
القرص أصلا: لقطةُ Hetzner. والمفرغُ المحلّيّ راحةُ استرجاعٍ سريعٍ فوقها، لا
هو النسخة.
...
**ومسارُ التعافي الحقيقيُّ يُختبر في لوحة Hetzner**: استرجاعُ لقطةٍ إلى خادم،
