...
> يكذّبه: النطاقُ يُحلّ إلى **`5.9.82.49`**، وهو في نطاق Hetzner، وCloudways
> لا تقدّم Hetzner أصلا. وأكّده من يملك الخادم: حاويات Docker، ولا وجودَ
> لـ`/etc/supervisor/conf.d` عنده.
>
