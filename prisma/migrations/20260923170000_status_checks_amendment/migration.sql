-- مولَّدٌ من تعليقات المخطّط: npx tsx scripts/status-checks.ts
-- 66 عمودَ حالةٍ، قيمُ كلٍّ منها من تعليقه
...
ALTER TABLE "TrainerContract" ADD CONSTRAINT "TrainerContract_status_allowed" CHECK ("status" IN ('draft', 'sent', 'amendment_requested', 'declined', 'revoked', 'signed', 'countersigned', 'expired', 'terminated'));
